...
| 04-06-01 | 06 | 5 | SCRP-01, SCRP-02, SCRP-03, SCRP-05 | T-04-20, T-04-21 | Orchestrator wires all 4 stages through ONE FetcherSession; `__init__.py` re-exports added (Cycle-1 #3 final step); **CYCLE-2 #5: run_scrape accepts injectable fetch_html for full-chain e2e; CYCLE-1 MEDIUM: live=False without fetch_html raises (network forbidden)** | unit + import | `python -c "from src.scraper import run_scrape, fetch_race_html, fetch_with_retry, enumerate_races, parse_race_html, normalize_to_parquet, FetcherSession, RaceRef; import inspect; assert 'fetch_html' in inspect.signature(run_scrape).parameters; print('Package API + Cycle-2 #5 injectable OK')"` | ✅ W0 | ⬜ pending |
