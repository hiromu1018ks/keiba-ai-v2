...
def sample_parquet_dir(tmp_path: Path) -> Path:
    ...
    race_df = pd.DataFrame({
        ...
        "race_flag_handicap": [None, True],
        "race_flag_age_restricted": [True, None],
        "race_flag_filly_only": [None, None],
        "race_flag_colt_only": [None, None],
        "race_flag_gelding_only": [None, None],
        "race_flag_mare_only": [None, None],
        "race_flag_stallion_only": [None, None],
        "race_flag_apprentice": [None, None],
        "race_flag_amateur": [None, None],
        "race_flag_female_jockey": [None, None],
        "race_flag_young_horse": [None, None],
        "race_flag_condition_race": [None, None],
        "race_flag_special_weight": [None, None],
        "race_flag_bonus_weight": [None, None],
        "race_flag_stakes": [None, None],
        "race_flag_graded_stakes": [None, None],
        "race_flag_listed": [None, None],
        "race_flag_open": [None, None],
        "race_flag_maiden": [None, None],
        "race_flag_allowance": [None, None],
    })
    ...
    odds_trifecta_df = pd.DataFrame({
        "race_id": ["201501010101", "201502020202"],
        "trifecta1_combo_1": [1, 4],
        "trifecta1_combo_2": [2, 5],
        "trifecta1_combo_3": [3, None],
        "trifecta1_odds": [990, 1500],
        "trifecta1_popularity": [1, 1],
        "trifecta2_combo_1": [None, None],
        "trifecta2_combo_2": [None, None],
        "trifecta2_combo_3": [None, None],
        "trifecta2_odds": [None, None],
        "trifecta2_popularity": [None, None],
        "trifecta3_combo_1": [None, None],
        "trifecta3_combo_2": [None, None],
        "trifecta3_combo_3": [None, None],
        "trifecta3_odds": [None, None],
        "trifecta3_popularity": [None, None],
    })
